...
class BackupControllerTest extends \OCA\EasyBackup\BaseTestCase {
	...
	protected function setUp() {
		...
		$this->backupServiceMock = $backupServiceMock = $this->getMockBuilder('\OCA\EasyBackup\Service\BackupService')->setMethods(array (
				'executeBackup', 'createStatusInformation'))->disableOriginalConstructor()->getMock();
	...
	public function testScheduleBackupOk() {
		...
		$this->statusContainerMock->expects($this->once())->method('getOverallStatus')->will($this->returnValue(\OCA\EasyBackup\StatusContainer::OK));

...
<div>
	<div class="bold">
		<?php p($l->t('5 easy steps to create a reliable backup on a German backup server'));?>
	</div>
	<div class="easybackup_explanation">
		1)
		<?php p($l->t('Get an account (2 months / 1GB free)  at'));?>
		<a href="http://www.trustedspace.de" target="_new">www.trustedspace.de</a>
	</div>
	<div class="easybackup_explanation">
		2)
		<?php p($l->t('Enter your newly created TrustedSpace backup host name'));?>
	</div>
	<span class="easybackup_label"> <?php p($l->t('TrustedSpace backup host'))?>:
	</span>&nbsp; <span id="easybackup_host"><span id="easybackup_hostName"><?php p($_['backupHostName']); ?> </span><a class="action" href="#">&nbsp;<img src="<?php print_unescaped(\OCP\Util::imagePath('core', 'actions/rename.svg')); ?>" />
	</a> </span>
</div>
...
<div>
	<div class="easybackup_explanation">
		...
		?>
		&nbsp; <img id="fidelbackup_explain_sshkey" helptext="<?php print_unescaped($helpText); ?>" src="<?php print_unescaped(\OCP\Util::imagePath('easybackup', 'help.png')); ?>">
	</div>
	<div class="easybackup_explanation">
		4)
		<?php p($l->t('Upload your newly created private key'));?>
	</div>
